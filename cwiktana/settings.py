"""
Django settings for cwiktana project.
...
SECRET_KEY = 'django-insecure-dh7^i2%=mf4l!^oxx36o^k&s(-zub9r9=6zzd(!5%+a%bjz%j('
...
ROOT_URLCONF = 'cwiktana.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'cwiktana', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'cwiktana.wsgi.application'
